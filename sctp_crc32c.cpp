...
// https://datatracker.ietf.org/doc/html/draft-ietf-tsvwg-sctpcsum-03

// some modifications have been done by the MyIP developer
...
uint32_t generate_crc32c(const uint8_t *const buffer, const size_t length)
{
	uint32_t crc32 = ~0L;
